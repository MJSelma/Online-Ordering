                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      String customerNamex = casesClass[index].customerName;
                          ...
                          if (snapshot.hasData) {
                            return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  filex.File file = filex.File(doc['message']);
                                  String basename =
                                      pathx.basename(file.path.split('/').last);
                                  String name = '';
                                  if (doc['type'] == 'file') {
